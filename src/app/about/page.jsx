      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            {/*/>*/}
            {/* BIOGRAPHY TITLE */}
            <h1 className="font-bold text-2xl">SHENSI TECH</h1>
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
              <p className="font-bold">At Our Company, we understand that every business is unique, which is why we offer customized software solutions to address your specific needs and challenges. Whether you require web applications, mobile apps, or enterprise software, our team of experienced developers is dedicated to bringing your vision to life. <br/></p>
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm">
                    Regular updates, troubleshooting, and technical support to keep your applications running smoothly.
                  </div>
                  {/*/!* JOB DATE *!/*/}
                  {/*<div className="p-3 text-red-400 text-sm font-semibold">*/}
                  {/*  2019 - 2024{" "}*/}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm">
                    Strategic guidance and planning to align your IT strategy with your business objectives and drive digital transformation.
                  </div>
                  {/*/!* JOB DATE *!/*/}
                  {/*<div className="p-3 text-red-400 text-sm font-semibold">*/}
                  {/*  2010 - 2019{" "}*/}
